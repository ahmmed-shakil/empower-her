            ...
            {modules?.map((module) => (
              <li key={module?._id}>
                <span>
                  ...
                  {module?.title}
                  <Link onClick={ClickHandler} to={`/lesson/${module?._id}`}>
                    Preview
                  </Link>
                </span>
                <small>Total lesson: {module?.lessons?.length}</small>
              </li>
            ))}
            {/* <li>
              <span>
                <i className="fi flaticon-play-button"></i>Overview of Editing
                <Link onClick={ClickHandler} to="/lesson">
                  Preview
                </Link>
              </span>
              <small>16 Minutes</small>
            </li>
            <li>
              <span>
                <i className="fi flaticon-e-learning"></i>Basic Editing
                Technology
              </span>
            </li>
            <li>
              <span>
                <i className="fi flaticon-knowledge"></i>Quiz
              </span>
      ...
      {/* <div className="wpo-course-text-top">
        ...
        <div className="course-curriculam">
          <ul>
            <li>
              <span>
                <i className="fi flaticon-play-button"></i>Introduction of
                Editing
                <Link onClick={ClickHandler} to="/lesson">
                  Preview
                </Link>

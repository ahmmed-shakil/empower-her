...
import abImg from "../../images/about/about_1.jpg";
import abImg2 from "../../images/about/about_2.jpg";
            ...
            <div className="col-lg-6 col-md-12 col-12">
              <div className="wpo-about-text">
                ...
                <p>
                  ...
                  accessible website and app for user engagement. Because
                ...
                <p>
                  it emphasizes networking and collaboration efforts to
                  establish connections with potential partners, NGOs, and
                  marginalized women. Human capital is prioritized, requiring a
                  skilled team for content creation, community management, and
                  partnership development. The initiative underscores the
                  importance of a reliable technology infrastructure, including
                  servers, software, and platform maintenance, to ensure a
                  user-friendly experience. Building collaborative relationships
                  is a key aspect, with a focus on partnerships with NGOs,
                  corporations, and educators for content creation and support.
                </p>
                <div className="wpo-about-features-wrap">
                  <div className="wpo-about-features-item">
                    ...
                    <div className="wpo-about-features-text">
                      <h5>
                        <CountUp end={100} enableScrollSpy />+ Courses
                      </h5>
                    </div>
                  </div>
                  <div className="wpo-about-features-item">
                    ...
                    <div className="wpo-about-features-text">
                      <h5>
                        <CountUp end={500} enableScrollSpy />+ Free Videos
                      </h5>
                    </div>
                  </div>
                  <div className="wpo-about-features-item">
                    ...
                    <div className="wpo-about-features-text">
                      <h5>
                        <CountUp end={3} enableScrollSpy />k Students
                      </h5>
                    </div>
                  </div>
                  <div className="wpo-about-features-item">
                    ...
                    <div className="wpo-about-features-text">
                      <h5>
                        <CountUp end={20} enableScrollSpy />+ Mentors
                      </h5>
                    </div>
                  </div>
                </div>
